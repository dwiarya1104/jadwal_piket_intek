            ...
            <table class="table table-striped datatables" style="font-size:13px;" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($schedule['status']== 'On Progress')
                                <a href="{{route('schedule.editUser', $schedule->id)}}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                            @elseif($schedule['status']== 'Incompleted')
                                <i class="fas fa-times" style="font-size: 30px; color:#e74a3b; align-items:center"></i>
                            @elseif($schedule['status']== 'Completed')
                                <i class="fas fa-check" style="font-size: 30px; color:#1cc88a; align-items:center"></i>
                            @endif
