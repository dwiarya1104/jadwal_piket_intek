                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            aria-labelledby="userDropdown">
                                ...
                                <li class="user-header align-items-center justify-content-center text-center">
                                    <img src="{{asset('assets/img/undraw_profile.svg')}}" class="img-circle my-3 mx-3" style="width:50px;" alt="User Image">
                                    <h6 class="col">
                                        {{ \Auth::user()->name  }}
                                        <br>
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a class="btn btn-default btn-flat float-right" style="font-size: 15px;" href="{{ route('logout') }}"
